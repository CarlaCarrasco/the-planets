   ...
   return (
      <div className="grid grid-cols-4 grid-flow-col gap-5 justify-items-stretch">
         <div className="text-left border-2 border-slate-700 py-3 px-4">
            <div className="text-slate-500 font-bold">Rotation Time</div>
            <h2 className="text-4xl">{rotation}</h2>
         </div>
         <div className="text-left border-2 border-slate-700 py-3 px-4">
            <div className="text-slate-500 font-bold">Revolution Time</div>
         ...
         <div className="text-left border-2 border-slate-700 py-3 px-4">
            <div className="text-slate-500">Average Temp.</div>
